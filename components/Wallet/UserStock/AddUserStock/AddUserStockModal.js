...
const AddUserStockModal = (prop) => {
    ...
    const postUserStock = async (request) => {
        try {
            console.log(request);
            const response = await axios.post(requestOptions.uri + '/api/userstock/adduserstock', request, {
                headers: requestOptions.headers
            }).then(() => {
                AlertUser('Stock Added Successfuly !', 'Stock added to your account wallet successfuly !');
            });
    ...
    function addUserStockButtonOnClick() {
        ...
        if (buyPrice <= 0 || buyPrice == '' || buyPrice == null) {
            ...
            setPostModel({ ...postModel, StockAmount: buyAmount, StockBuyPrice: buyPrice, StockCode: stockDropDownValue });
            setModelReady(true);
                ...
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        ...
                        <View style={styles.inputContainer}>
                            <StockDropDownPicker value={stockDropDownValue} setValue={setStockDropDownValue} />
